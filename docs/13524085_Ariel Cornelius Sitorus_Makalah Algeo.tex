...
% =============================================================================
% HEADER CONFIGURATION (IF2123 REQUIRED)
% =============================================================================
...
The paper is structured as follows: Section II covers theoretical foundations on vector spaces and eigendecomposition. Section III explains the drone simulation methodology. Section IV presents the Python implementation. Section V discusses experimental results, and Section VI contains conclusions.
...
\begin{lstlisting}[caption={data\_generation.py -- Synthetic drone data generation}]
import numpy as np

def generate_linear_flight(n_samples=500, seed=42):
    """Generate anisotropic linear flight data."""
    np.random.seed(seed)
    white_data = np.random.randn(3, n_samples)
    
    # Scaling: variances = (100, 9, 1)
    scale = np.array([[10, 0, 0],
                      [0,  3, 0],
                      [0,  0, 1]])
    
    # Rotation matrices (45 deg)
    theta = np.radians(45)
    ...
    transform = rotation_y @ rotation_z @ scale
...
\begin{lstlisting}[caption={eigenanalysis.py -- Core eigenstructure analysis}]
import numpy as np
...
def eigendecompose(matrix):
    """Eigendecomposition with descending sort."""
...
def pca_transform(data, n_components=2):
    ...
    explained = result['explained_variance'][:n_components]
    return projected, explained, W
\end{lstlisting}

\subsection{Interpretation Module}

\begin{lstlisting}[caption={interpretation.py -- Flight dynamics interpretation}]
import numpy as np
...
\begin{lstlisting}[caption={visualization.py -- 3D visualization functions}]
import numpy as np
import matplotlib.pyplot as plt
from mpl_toolkits.mplot3d import Axes3D

def visualize_eigenanalysis(data, analysis, title=None, 
                            save_path=None):
    ...
    for i in range(3):
        ...
        ax.quiver(*mean, *(evecs[:,i]*length),
                  color=colors[i], linewidth=3,
                  label=f'v{i+1} ({evals[i]:.1f})')
...
\begin{lstlisting}[caption={main.py -- Main execution script}]
...
def main():
    ...
    # Scenario B: Spiral Flight
    spiral_data = generate_spiral_flight(n_samples=500)
    spiral_analysis = analyze_eigenstructure(spiral_data)
    
    visualize_eigenanalysis(spiral_data, spiral_analysis,
                            title="Spiral Flight Analysis",
                            save_path="spiral_flight.png")
